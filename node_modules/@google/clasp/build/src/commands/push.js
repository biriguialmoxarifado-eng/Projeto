        ...
        if (!options.json && skipped.length > 0) {
            skipped.forEach(item => {
                if (item.reason === 'symlink') {
                    console.warn(intl.formatMessage({ id: "+hsD64", defaultMessage: [{ type: 0, value: "Security Warning: Skipping symbolic link " }, { type: 1, value: "file" }, { type: 0, value: ". Symbolic links are not supported." }] }, { file: item.localPath }));
                }
            });
        }
