...
export class Clasp {
    ...
    withContentDir(contentDir) {
        ...
        if (contentDir !== projectRootDir && !isInside(projectRootDir, contentDir)) {
            throw new Error(`Security Error: Content directory "${contentDir}" resolves outside the project root "${projectRootDir}". ` +
...
export async function initClaspInstance(options) {
    ...
    if (!projectRoot) {
        ...
        return new Clasp({
            ...
            files: {
                ...
                allowSymlinks: (_b = options.allowSymlinks) !== null && _b !== void 0 ? _b : false,
            },
    ...
    const allowSymlinks = (_d = (_c = options.allowSymlinks) !== null && _c !== void 0 ? _c : Boolean(config.allowSymlinks)) !== null && _d !== void 0 ? _d : false;
    ...
    const isValid = (contentDir === projectRoot.rootDir || isInside(projectRoot.rootDir, contentDir)) &&
        (allowSymlinks || contentDirReal === rootDirReal || isInside(rootDirReal, contentDirReal));
    if (!isValid) {
        throw new Error(`Security Error: srcDir "${(_e = config.srcDir) !== null && _e !== void 0 ? _e : config.rootDir}" escapes project root.\n` +
            `  Resolved: ${contentDir}\n` +
    ...
    return new Clasp({
        ...
        files: {
            ...
            skipSubdirectories: (_f = config.skipSubdirectories) !== null && _f !== void 0 ? _f : false,
            allowSymlinks,
        },
        project: {
...
async function findProjectRootDir(configFilePath) {
