...
function AP_ENTRADA_htmlPatrimonio_(r) {
  ...
  var estilo = '<style>' +
    ...
    /* cabeçalho discreto: quem lê a etiqueta quer ver a ferramenta,
       não a marca. A identidade fica pequena e no canto. */
    '.topo{background:#fff;border-bottom:1px solid #E3E9F0;padding:10px 16px;' +
    'display:flex;align-items:center;justify-content:space-between;gap:12px;' +
    'position:sticky;top:0;z-index:10}' +
    '.emp{display:flex;align-items:center;gap:7px}' +
    '.emp-c{font-family:Georgia,serif;font-size:19px;font-weight:900;color:#0B5FFF;' +
    'line-height:1}' +
    '.emp-n{font-size:13px;font-weight:800;color:#0B2A55;letter-spacing:.06em;line-height:1.15}' +
    '.emp-n small{display:block;font-size:9px;font-weight:400;color:#9AA5B1;letter-spacing:0}' +
    '.topo-bts{display:flex;gap:6px}' +
    '.tb{background:#F0F4F8;border:1px solid #E3E9F0;color:#4A5866;border-radius:8px;' +
    'padding:7px 12px;font-size:12.5px;font-family:inherit;cursor:pointer;font-weight:600}' +
    '.tb:hover{background:#E3E9F0}' +
    '.tb.principal{background:#0B2A55;color:#fff;border-color:#0B2A55}' +
  ...
  var topo = '<div class="topo">' +
    '<div class="emp">' +
    '<span class="emp-c">C</span>' +
    '<span class="emp-n">' + esc(EMPRESA) + '<small>Ficha do patrimônio</small></span>' +
    '</div>' +
    '<div class="topo-bts">' +
    '<button class="tb" onclick="window.print()">Imprimir</button>' +
    '<button class="tb principal" onclick="window.print()">PDF</button>' +
    '</div></div>';
