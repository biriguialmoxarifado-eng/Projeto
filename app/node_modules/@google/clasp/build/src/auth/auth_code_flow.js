...
export class AuthorizationCodeFlow {
    ...
    async authorize(scopes) {
        ...
        const authUrl = this.oauth2Client.generateAuthUrl({
            ...
            code_challenge_method: 'S256', // Temporary workaround since @types/google-auth-library isn't fully synced or the type restricts literal strings, but type checking fails without deep import or `any` here.
        });
     ...
     * @throws {Error} If not implemented by the subclass.
     */
    async promptAndReturnCode(_authorizationUrl, _expectedState) {
        throw new Error('Not implemented');
    }
}
/**
