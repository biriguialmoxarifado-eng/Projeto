    ...
    try {
        ...
        if (!options.json && writeResult.skipped.length > 0) {
            writeResult.skipped.forEach(item => {
                console.warn(intl.formatMessage({ id: "yB+j15", defaultMessage: [{ type: 0, value: "Security Warning: Skipping write of " }, { type: 1, value: "file" }, { type: 0, value: " (" }, { type: 1, value: "reason" }, { type: 0, value: ")." }] }, {
                    file: item.localPath,
